...
public class VectorSearch {
    ...
    public void top5(float[] q, int[] outIdx) {
        ...
        float[] v = VectorStore.vectors;

        for (int i=0, base=0; i < VectorStore.size; i++, base+=14) {
            ...
            if (s > b0) {
                b4=b3;i4=i3; b3=b2;i3=i2; b2=b1;i2=i1; b1=b0;i1=i0;
                b0=s;i0=i;
            } else if (s > b1) {
                b4=b3;i4=i3; b3=b2;i3=i2; b2=b1;i2=i1;
                b1=s;i1=i;
            } else if (s > b2) {
        ...
        outIdx[0]=i0; outIdx[1]=i1; outIdx[2]=i2;
        outIdx[3]=i3; outIdx[4]=i4;
    }
}